...
class CasaMulherProtese extends StatelessWidget {
  const CasaMulherProtese({super.key});
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  // Título
                  const Text(
                    'Socilitar Tenda ou Casa Mulher',
                    style: TextStyle(
                      color: Colors.white,
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: const Text(
                "Aquisição de prótese de mama removível e"
                "sutiã especial para mulheres que realizam retirada"
                "de mama"
                ,
                style: TextStyle(
                  color: Color(0xFF1F2937),
            ...
            Column(
              children: [
                ...
                _ActionCard(
                  ...
                  onTap: () {
                   context.go(AppRoutes.MulherProteseInfo);
