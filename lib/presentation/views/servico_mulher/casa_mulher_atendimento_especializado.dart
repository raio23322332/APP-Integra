...
class CasaMulherAtendimentoEspecializado extends StatelessWidget {
  const CasaMulherAtendimentoEspecializado({super.key});
            ...
            Column(
              children: [
                ...
                _ActionCard(
                  ...
                  onTap: () {
                   context.go(AppRoutes.CasaMulherinformacaoespecializada);
