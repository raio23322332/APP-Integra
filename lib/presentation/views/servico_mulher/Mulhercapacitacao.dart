...
class Mulhercapacitacao extends StatelessWidget {
  const Mulhercapacitacao({super.key});
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  // Título
                  const Text(
                    'Capacitação do conselho da mulher '
                      '',
                    style: TextStyle(
                      color: Colors.white,
            ...
            Column(
              children: [
                ...
                _ActionCard(
                  ...
                  onTap: () {
                   context.go(AppRoutes.MulherCapacitacaoInfo);
