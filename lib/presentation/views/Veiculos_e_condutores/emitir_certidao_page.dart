...
import 'package:integra_app/presentation/viewmodels/veiculos_e_condutores/emitir_certidao_viewmodel.dart';
import 'package:provider/provider.dart';

class EmitirCertidaoPage extends StatelessWidget {
  const EmitirCertidaoPage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
        create: (_) => EmitirCertidaoViewModel(),
        child: Consumer<EmitirCertidaoViewModel>(
              ...
              body: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Título
                    Text(
                      "Comprove que o pagamento do IPVA do veículo está em dia",
                      style: TextStyle(
                        fontSize: 22,
                        fontWeight: FontWeight.bold,
