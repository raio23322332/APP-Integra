...
import 'package:integra_app/presentation/viewmodels/veiculos_e_condutores/consultar_ipva_modelo_viewmodel.dart';
import 'package:provider/provider.dart';

class ConsultarIpvaModeloPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (_) => ConsultarIpvaModeloViewModel(),
      child: Consumer<ConsultarIpvaModeloViewModel>(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _DropDownCampo(
                    ...
                    valor: viewModel.modeloSelecionado,
                    itens: const [
                      "Fiat Toro",
                      "Honda Civic",
                      "Toyota Corolla",
                    ...
                    onChanged: (v) => viewModel.setModelo(v),
                  ),
                  ...
                  _DropDownCampo(
                    ...
                    valor: viewModel.anoSelecionado,
                    itens: const ["2024", "2023", "2022", "2021"],
                    onChanged: (v) => viewModel.setAno(v),
                  ),
