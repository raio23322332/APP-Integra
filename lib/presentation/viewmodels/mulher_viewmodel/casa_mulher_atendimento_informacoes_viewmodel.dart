...
class CasaMulherAtendimentoInformacoesViewModel extends BaseViewModel { // Changed class name
  // Textos fixos
...
"Sala Lilás é um espaço de atendimento às **mulheres em situação de violência doméstica e outras vulnerabilidades** com serviços de **acolhimento psicológico e orientações em general**."
...
* **Quem pode solicitar?**
"Mulher pode ser atendida **até sem documento de identificação**, sendo que no decorrer do acolhimento psicossocial será dado suporte para documentação."
